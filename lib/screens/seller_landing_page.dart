...
class LandingPage extends StatefulWidget {
  ...
  const LandingPage({super.key, required this.businessName});
            ...
            floatingActionButton: FloatingActionButton.extended(
              ...
              onPressed: (){
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            OrderScreeen(businessName: widget.businessName, selectedAddress: PickupAddress(id: '', fullName: '', pincode: '', houseNumber: '', city: '', state: ''),)));
              },
              icon: Icon(Icons.add),
              backgroundColor: const Color.fromARGB(255, 67, 160, 71),
            ),
